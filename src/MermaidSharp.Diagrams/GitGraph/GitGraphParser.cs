...
public class GitGraphParser : IDiagramParser<GitGraphModel>
{
    ...
    static GitGraphModel BuildModel(List<GitOperation> operations, (string? direction, string? mainBranch) options)
    {
        ...
        if (options.direction != null)
        {
            ...
            {
                "TB" or "TD" => Core.Models.Direction.TopToBottom,
                "BT" => Core.Models.Direction.BottomToTop,
                "LR" => Core.Models.Direction.LeftToRight,
                "RL" => Core.Models.Direction.RightToLeft,
                _ => Core.Models.Direction.LeftToRight
            };
        }
        else
        {
            model.Direction = Core.Models.Direction.LeftToRight; // Git graphs default to LR
        }
