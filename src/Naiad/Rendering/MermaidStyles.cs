...
public static class MermaidStyles
{
    ...
    /// </summary>
    public const string PieStyles = BaseStyles + """#naiad .pieCircle{stroke:black;stroke-width:2px;opacity:0.7;}#naiad .pieOuterCircle{stroke:black;stroke-width:2px;fill:none;}#naiad .pieTitleText{text-anchor:middle;font-size:25px;fill:black;font-family:"trebuchet ms",verdana,arial,sans-serif;}#naiad .slice{font-family:"trebuchet ms",verdana,arial,sans-serif;fill:#333;font-size:17px;}#naiad .legend text{fill:black;font-family:"trebuchet ms",verdana,arial,sans-serif;font-size:17px;}""";
    ...
    /// </summary>
    public const string FlowchartStyles = BaseStyles + "#naiad p{margin:0;}#naiad .marker{fill:#333333;stroke:#333333;}#naiad .marker.cross{stroke:#333333;}#naiad span{fill:#333;color:#333;}#naiad .flowchart-link{stroke:#333333;fill:none;}#naiad .edgeLabel{background-color:rgba(232,232,232, 0.8);text-align:center;}#naiad .edgeLabel p{background-color:rgba(232,232,232, 0.8);}#naiad .edgeLabel rect{opacity:0.5;background-color:rgba(232,232,232, 0.8);fill:rgba(232,232,232, 0.8);}";
}
